                ...
                <div className="flex flex-col justify-center items-center mx-5 my-11 bg-gradient-to-br from-[#ececec] to-[#e6e6e6] rounded-lg shadow-md">
                    <section className="flex flex-col justify-between">
                        ...
                        <div className="flex flex-col my-5 justify-center items-center">
                            <h2 className="text-[1rem]">Agrega un comentario si lo deseas:</h2>
                            <form className="flex items-center p-2 overflow-hidden">
                                <textarea className="p-2 text-[12px]"
                                value={comment}
                                placeholder='Ej: sin cebolla!'
                                onChange={handleComment}
                                />
<<<<<<< HEAD:src/components/ModalCart.jsx
                            </form>
                            </div>
...
>>>>>>> 421941c2b4219465d2d69ed6a84cfdf91dcb92fb:src/components/ModalPedidos.jsx
                        </div>
                    </section>
